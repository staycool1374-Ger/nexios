...
### Important Details
- Branch `main`. Issue #2 commit: `ef9b748b` (feat IRQ caps + user-space delivery).
...
#### Active
- (none outstanding) — issues #1, #2, #3, #5 closed; issue #6 fully remediated (P0–P8, SIL 3 approved, closed); full `all` 963/963 (registered 978).
