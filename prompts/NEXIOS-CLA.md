...
Please read this document carefully before signing. By submitting a contribution through GitHub, you agree to the terms below.

---

### 1. Definitions
* **"Contribution"** means any source code, documentation, verification scripts, or other material submitted by you to the Project, including any modifications or additions to existing work.
...
* **Crucially**, sublicense the Contribution under any license terms chosen by the Owner, including but not limited to the GNU General Public License Version 3 (GPLv3) and alternative, proprietary, closed-source commercial licenses.
...
* If your employer has rights to intellectual property you create, you have received permission to make this Contribution on behalf of that employer or that your employer has waived such rights for the Project.
* Each of Your Contributions is Your original creation (you did not copy it from third-party code with conflicting licenses).

### 6. No Warranty (As-Is)
Except for the express warranties stated in Section 5, Your Contribution is provided on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied, including, without limitation, any warranties or conditions of TITLE, NON-INFRINGEMENT, MERCHANTABILITY, or FITNESS FOR A PARTICULAR PURPOSE.
