...
// NOTE (issue #95): shared-object entry points (load_shared_object,
// resolve_dependencies, apply_relocations) are declared canonically in
// <kernel/elf/elf_shared.hpp> (already included above); they are NOT
// re-declared here.
